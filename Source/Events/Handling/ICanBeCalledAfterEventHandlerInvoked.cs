...
namespace Aksio.Events.Handling
{
    ...
    /// </summary>
    public interface ICanBeCalledAfterEventHandlerInvoked
    {
        /// <summary>
        /// Called after every handle method is invoked on an event handler.
        /// </summary>
        ...
        Task AfterInvoked(IEventHandler eventHandler, object @event, EventContext eventContext);
    }
}